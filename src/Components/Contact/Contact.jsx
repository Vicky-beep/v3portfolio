...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_i522enu', 'template_l2rj7ja', form.current, 'Z0XKqzV8vCuriNgp3')
     e.target.reset();
    };
  return (
    <section className="contact section" id="contact">
        ...
        <div className="contact-container container grid">
                ...
                <div className="contact-info">
                    ...
                    <div className="contact-card">
                        ...
                        <span className="contact-card-data">
                            victorybalogun@gmail.com
                        </span>
                        <a href="mailto:victorybalogun@gmail.com" className="contact-button">Write Me
                    ...
                    <div className="contact-card">
                        ...
                        <h3 className="contact-card-title">Phone No.</h3>
                        <span className="contact-card-data">
                            +234-703-686-2585
                        </span>
                        <a href="+tel:0703862585" className="contact-button">Call Me
                        <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                        </a>
                    </div>
                    {/* third */}
                    ...
                    <div className="contact-card">
                        ...
                        <a href="https://www.linkedin.com/in/victory-omowumi-b-1465a9101" className="contact-button">Connect
                        <i className="bx bx-right-arrow-alt contact-button-icon"></i>
                        </a>
                    </div>
                </div>
            ...
            <div className="contact-content">
              <h3 className="contact-title">Leave a mesaage</h3> 
              ...
              <form ref={form} onSubmit={sendEmail} className="contact-form">
                ...
                <div className="contact-form-div contact-form-textarea">
                        ...
                        <textarea name="message" id="message" cols="0" rows="7" className="contact-form-input" placeholder="Enter your message"></textarea>
                </div>
